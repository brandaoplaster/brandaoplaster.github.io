<template>
  <section class="hero home " id="home">
    <div class="hero-body space-padding">
      <div class="container">
        ...
        <div id="container-cloud">
          ...
          <div class="columns is-multiline">
            ...
            <div class="column is-three-fifths is-offset-one-fifth">
              <h1 class="title-welcome is-family-monospace">
                Welcome
              </h1>
            </div>

            <div class="column is-half is-offset-one-quarter has-text-center">
              <h2 class="subtitle-welcome is-size-4 is-family-monospace">
                to our page
              </h2>
            </div>
          </div>
...
.clouds.Background:nth-child(10) {
